 ...
 */
  ...
  #error "Thermal Runaway Protection for hotends is now enabled with THERMAL_PROTECTION_HOTEND."
  ...
  #error "FILAMENTCHANGEENABLE is now. Please update your configuration."
