...
void kill_screen(const char* lcd_msg) {
  ...
  static void lcd_main_menu() {
    ...
    MENU_ITEM(submenu, "PROCESO", lcd_prepare_menu);
  ...
  static void lcd_prepare_submenu_config() {
    START_MENU();
    MENU_ITEM(back, MSG_BACK);
